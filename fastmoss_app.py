...
def file_listing():
    ...
    return {"csv_files": csv_files, "download_dirs": download_dirs}
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    input, textarea { width:100%; border:1px solid #d7dce5; border-radius:6px; padding:10px 11px; font:inherit; outline:none; }
    input:focus, textarea:focus { border-color:var(--pink); box-shadow:0 0 0 3px rgba(254,32,98,.08); }
    ...
    .files { display:grid; grid-template-columns:1fr 1fr; gap:14px; margin-top:16px; }
